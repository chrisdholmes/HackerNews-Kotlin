...
interface HNApiService {
    ...
    //getSearchQuery() returns 50 articles matching a full string text query
    @GET("search?hitsPerPage=50")
    suspend fun getSearchQuery(@Query("query") searchQuery: String): Hits
}
